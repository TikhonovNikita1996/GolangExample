...
import (
	...
	"github.com/TikhonovNikita1996/Go-microservises-project/platform/testcontainers"
	"github.com/TikhonovNikita1996/Go-microservises-project/platform/testcontainers/app"
	"github.com/TikhonovNikita1996/Go-microservises-project/platform/testcontainers/mongo"
	"github.com/TikhonovNikita1996/Go-microservises-project/platform/testcontainers/network"
	"github.com/TikhonovNikita1996/Go-microservises-project/platform/testcontainers/path"
)

const (
	// Параметры для контейнеров
	ufoAppName    = "inventory-app"
	ufoDockerfile = "deploy/docker/inventory/Dockerfile"
