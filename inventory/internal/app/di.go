...
import (
	...
	api "github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/api/inventory/v1"
	"github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/config"
	"github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/repository"
	"github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/repository/part"
	"github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/service"
	inventoryService "github.com/TikhonovNikita1996/Go-microservises-project/inventory/internal/service/part"
...
func (d *diContainer) InventoryV1API(ctx context.Context) inventoryV1.InventoryServiceServer {
	if d.inventoryV1API == nil {
		d.inventoryV1API = api.NewAPI(d.InventoryService(ctx))
	}
...
func (d *diContainer) InventoryRepository(ctx context.Context) repository.InventoryRepository {
	if d.inventoryRepository == nil {
		d.inventoryRepository = part.NewRepository(d.MongoDBHandle(ctx))
	}
