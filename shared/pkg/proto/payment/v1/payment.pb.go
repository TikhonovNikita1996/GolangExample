...
type PayOrderRequest struct {
	...
	// Данные для оплаты
	Info          *PaymentInfo `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`
...
func (x *PayOrderRequest) GetInfo() *PaymentInfo {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *PaymentInfo) GetOrderUuid() string {
	if x != nil {
		return x.OrderUuid
	}
	return ""
...
func (x *PaymentInfo) GetUserUuid() string {
	if x != nil {
		return x.UserUuid
	}
	return ""
...
const file_payment_v1_payment_proto_rawDesc = "" +
	...
	"\x04info\x18\x01 \x01(\v2\x17.payment.v1.PaymentInfoR\x04info\"=\n" +
	"\x10PayOrderResponse\x12)\n" +
	"\x10transaction_uuid\x18\x01 \x01(\tR\x0ftransactionUuid\"\x8b\x01\n" +
	"\vPaymentInfo\x12\x1d\n" +
	"\n" +
	"order_uuid\x18\x01 \x01(\tR\torderUuid\x12\x1b\n" +
	"\tuser_uuid\x18\x02 \x01(\tR\buserUuid\x12@\n" +
	"\x0epayment_method\x18\x03 \x01(\x0e2\x19.payment.v1.PaymentMethodR\rpaymentMethod*\xa3\x01\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB_Z]github.com/TikhonovNikita1996/Go-microservises-project/shared/pkg/proto/payment/v1;payment_v1b\x06proto3"
...
var file_payment_v1_payment_proto_goTypes = []any{
	...
	(*PaymentInfo)(nil),      // 3: payment.v1.PaymentInfo
}
var file_payment_v1_payment_proto_depIdxs = []int32{
	3, // 0: payment.v1.PayOrderRequest.info:type_name -> payment.v1.PaymentInfo
	0, // 1: payment.v1.PaymentInfo.payment_method:type_name -> payment.v1.PaymentMethod
