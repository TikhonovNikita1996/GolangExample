...
type NotificationMethod struct {
	...
	ProviderName  string                 `protobuf:"bytes,1,opt,name=provider_name,json=providerName,proto3" json:"provider_name,omitempty"` // Поставщик (telegram, email, push и т.д.)
	Target        string                 `protobuf:"bytes,2,opt,name=target,proto3" json:"target,omitempty"`                                 // Адрес/идентификатор назначения
...
const file_common_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"updated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAtB]Z[github.com/TikhonovNikita1996/Go-microservises-project/shared/pkg/proto/common/v1;common_v1b\x06proto3"
