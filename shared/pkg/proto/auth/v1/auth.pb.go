...
type WhoamiResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Session       *v1.Session            `protobuf:"bytes,1,opt,name=session,proto3" json:"session,omitempty"` // Сессия
	User          *v1.User               `protobuf:"bytes,2,opt,name=user,proto3" json:"user,omitempty"`       // Пользователь
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x06Whoami\x12\x16.auth.v1.WhoamiRequest\x1a\x17.auth.v1.WhoamiResponseBYZWgithub.com/TikhonovNikita1996/Go-microservises-project/shared/pkg/proto/auth/v1;auth_v1b\x06proto3"
