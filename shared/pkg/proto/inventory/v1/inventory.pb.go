...
type GetPartsRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Данные для оплаты
	PartsFilter   *PartsFilter `protobuf:"bytes,1,opt,name=parts_filter,json=partsFilter,proto3" json:"parts_filter,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetPartsRequest) Reset() {
	*x = GetPartsRequest{}
...
func (x *GetPartsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPartsRequest) ProtoMessage() {}

func (x *GetPartsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_inventory_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPartsRequest.ProtoReflect.Descriptor instead.
func (*GetPartsRequest) Descriptor() ([]byte, []int) {
	return file_inventory_v1_inventory_proto_rawDescGZIP(), []int{2}
}

func (x *GetPartsRequest) GetPartsFilter() *PartsFilter {
	if x != nil {
		return x.PartsFilter
	}
	return nil
}
...
func (x *GetPartsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPartsResponse) ProtoMessage() {}

func (x *GetPartsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_inventory_v1_inventory_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPartsResponse.ProtoReflect.Descriptor instead.
func (*GetPartsResponse) Descriptor() ([]byte, []int) {
	return file_inventory_v1_inventory_proto_rawDescGZIP(), []int{3}
}

func (x *GetPartsResponse) GetParts() []*Part {
	if x != nil {
		return x.Parts
	}
	return nil
...
type PartsFilter struct {
	...
	Names                 []string               `protobuf:"bytes,2,rep,name=names,proto3" json:"names,omitempty"`                                                              // Список имён. Пусто — не фильтруем по имени
	...
	Tags                  []string               `protobuf:"bytes,5,rep,name=tags,proto3" json:"tags,omitempty"`                                                                // Список тегов. Пусто — не фильтруем по тегам
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type Part struct {
	...
	Dimensions    *Dimensions            `protobuf:"bytes,7,opt,name=dimensions,proto3" json:"dimensions,omitempty"`                                                                        // Габариты
	Manufacturer  *Manufacturer          `protobuf:"bytes,8,opt,name=manufacturer,proto3" json:"manufacturer,omitempty"`                                                                    // Производитель
	Tags          []string               `protobuf:"bytes,9,rep,name=tags,proto3" json:"tags,omitempty"`                                                                                    // Теги для поиска
...
type Value_Int64Value struct {
	Int64Value int64 `protobuf:"varint,2,opt,name=int64_value,json=int64Value,proto3,oneof"` // Целое число
}

type Value_DoubleValue struct {
	DoubleValue float64 `protobuf:"fixed64,3,opt,name=double_value,json=doubleValue,proto3,oneof"` // Дробное число
}
...
type Manufacturer struct {
	...
	Website       string                 `protobuf:"bytes,3,opt,name=website,proto3" json:"website,omitempty"` // Официальный сайт
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x04part\x18\x01 \x01(\v2\x12.inventory.v1.PartR\x04part\"O\n" +
	"\x0fGetPartsRequest\x12<\n" +
	"\fparts_filter\x18\x01 \x01(\v2\x19.inventory.v1.PartsFilterR\vpartsFilter\"<\n" +
	"\x10GetPartsResponse\x12(\n" +
	...
	"\x10transaction_uuid\x18\x01 \x01(\tR\x0ftransactionUuid\"\xd5\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\bGetParts\x12\x1d.inventory.v1.GetPartsRequest\x1a\x1e.inventory.v1.GetPartsResponseBbZ`github.com/TikhonovNikita1996/Go-microservises-project/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*GetPartsRequest)(nil),       // 3: inventory.v1.GetPartsRequest
	(*GetPartsResponse)(nil),      // 4: inventory.v1.GetPartsResponse
	(*PartsFilter)(nil),           // 5: inventory.v1.PartsFilter
	(*PayOrderResponse)(nil),      // 6: inventory.v1.PayOrderResponse
	(*Part)(nil),                  // 7: inventory.v1.Part
	(*Value)(nil),                 // 8: inventory.v1.Value
	(*Manufacturer)(nil),          // 9: inventory.v1.Manufacturer
	(*Dimensions)(nil),            // 10: inventory.v1.Dimensions
	nil,                           // 11: inventory.v1.Part.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 12: google.protobuf.Timestamp
}
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	7,  // 0: inventory.v1.GetPartResponse.part:type_name -> inventory.v1.Part
	5,  // 1: inventory.v1.GetPartsRequest.parts_filter:type_name -> inventory.v1.PartsFilter
	7,  // 2: inventory.v1.GetPartsResponse.parts:type_name -> inventory.v1.Part
	...
	10, // 5: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	9,  // 6: inventory.v1.Part.manufacturer:type_name -> inventory.v1.Manufacturer
	...
	3,  // 12: inventory.v1.InventoryService.GetParts:input_type -> inventory.v1.GetPartsRequest
	2,  // 13: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	4,  // 14: inventory.v1.InventoryService.GetParts:output_type -> inventory.v1.GetPartsResponse
