...
const (
	...
	InventoryService_GetParts_FullMethodName = "/inventory.v1.InventoryService/GetParts"
)
...
type InventoryServiceClient interface {
	...
	GetParts(ctx context.Context, in *GetPartsRequest, opts ...grpc.CallOption) (*GetPartsResponse, error)
}
...
func (c *inventoryServiceClient) GetParts(ctx context.Context, in *GetPartsRequest, opts ...grpc.CallOption) (*GetPartsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPartsResponse)
	err := c.cc.Invoke(ctx, InventoryService_GetParts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	GetParts(context.Context, *GetPartsRequest) (*GetPartsResponse, error)
...
func (UnimplementedInventoryServiceServer) GetParts(context.Context, *GetPartsRequest) (*GetPartsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetParts not implemented")
}
...
func _InventoryService_GetParts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPartsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).GetParts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_GetParts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).GetParts(ctx, req.(*GetPartsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetParts",
			Handler:    _InventoryService_GetParts_Handler,
		},
	},
