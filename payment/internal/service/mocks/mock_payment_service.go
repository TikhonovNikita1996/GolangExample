...
// PayOrder provides a mock function with given fields: ctx, orderUuid, userUuid
func (_m *PaymentService) PayOrder(ctx context.Context, orderUuid string, userUuid string) (string, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (string, error)); ok {
		return rf(ctx, orderUuid, userUuid)
	}
...
//   - orderUuid string
//   - userUuid string
func (_e *PaymentService_Expecter) PayOrder(ctx interface{}, orderUuid interface{}, userUuid interface{}) *PaymentService_PayOrder_Call {
	return &PaymentService_PayOrder_Call{Call: _e.mock.On("PayOrder", ctx, orderUuid, userUuid)}
}

func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, orderUuid string, userUuid string)) *PaymentService_PayOrder_Call {
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context, string, string) (string, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
